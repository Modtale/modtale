...
const avatar = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="800"><path fill="#0f172a" d="M0 0h800v800H0z"/><path d="M400 180 590.5 290V510L400 620 209.5 510V290Z" fill="#4d70aa"/></svg>`;
