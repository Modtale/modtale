...
const BlueskyIcon = ({ className }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 10.8c-1.6-4.2-7.3-10-10-10 0 0-2 2-2 10 .2 4 1.4 6 5 8 2.8 1.5 5.5.4 7-1.3 1.5 1.7 4.2 2.8 7 1.3 3.6-2 4.8-4 5-8 0-8-2-10-2-10-2.7 0-8.4 5.8-10 10z"/>
    </svg>
);
