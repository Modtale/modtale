        ...
        <div className="min-h-screen bg-slate-50 dark:bg-modtale-dark pb-20">
            ...
            <div className="max-w-7xl min-[1600px]:max-w-[100rem] mx-auto px-4 md:px-6 transition-[max-width] duration-300">
                ...
                {loadingProjects && page === 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 min-[1600px]:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 min-[1600px]:grid-cols-4 gap-4 md:gap-6 gap-y-8">
