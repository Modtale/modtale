...
export const HistoryModal: React.FC<HistoryModalProps> = ({
    ...
    return (
        <div className={theme.components.modalOverlay} onClick={onClose}>
            <div className={`${theme.components.modalContent} max-w-3xl max-h-[85dvh]`} onClick={e => e.stopPropagation()}>
                ...
                <div className={theme.components.modalBody}>
                    <div className="space-y-6">
                        {visibleHistory.map((ver: any) => {
                            ...
                            return (
                                <div key={ver.id} className={`${theme.colors.bgSurface} border ${theme.colors.border} rounded-xl p-5 shadow-sm hover:border-slate-300 dark:hover:border-white/10 transition-colors`}>
                                    <div className={`flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 border-b ${theme.colors.borderFaint} pb-4`}>
                                        <div>
                                        ...
                                        <Link
                                            ...
                                            className={`px-4 py-2 ${theme.colors.bgSurfaceAlt} ${theme.colors.accentHover} hover:text-white ${theme.colors.textSecondary} rounded-lg font-bold text-sm transition-all flex items-center justify-center gap-2`}
                                        >
