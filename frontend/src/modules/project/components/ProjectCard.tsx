...
export const ProjectCard: React.FC<ProjectCardProps> = React.memo(({ project, path, isFavorite, onToggleFavorite, isLoggedIn, priority = false, viewStyle = 'grid', onReady, isVisible = true, disableNavigation = false, versionLabel, bundledConfigCount = 0, sourceLabel }) => {
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center sm:justify-start relative z-20 pointer-events-none">
                    <div className="flex justify-between items-start gap-2 sm:gap-4">
                        <div className="min-w-0 flex-1">
                            ...
                            {(versionLabel || bundledConfigCount > 0 || sourceLabel) && (
                                <div className="mt-2 flex flex-wrap items-center gap-2">
                                    ...
                                    {sourceLabel && <span className="inline-flex items-center rounded-md border border-orange-500/20 bg-orange-500/10 px-2 py-0.5 text-xs font-semibold text-orange-700 dark:text-orange-300">{sourceLabel}</span>}
