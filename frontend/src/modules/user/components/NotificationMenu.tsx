                                ...
                                {notifications.map(n => (
                                    ...
                                    >
                                        <OptimizedImage
                                            ...
                                            alt=""
                                            baseWidth={40}
                                            className="w-10 h-10 rounded-md shrink-0 border border-slate-200 dark:border-white/5 shadow-sm object-cover"
                                        />
                                        <div className="flex-1 min-w-0 pr-12">
                                            ...
                                            <div className="text-xs text-slate-600 dark:text-slate-400 whitespace-pre-wrap break-words">{n.message}</div>
