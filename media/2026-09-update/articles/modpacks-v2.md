...
## “What mods are you using?” Send a list.

You don’t always need to publish a project to share a good setup. Create a mod list from a world in the launcher, choose the supported configs to include, and share its link. The recipient opens a Modtale web page with the projects, recorded versions, and included configs together.

They can look through the list before choosing Install with launcher , or Download zip when the list supports a web download. Lists containing CurseForge entries use the launcher so those files come directly from their source. There’s no need to piece the lineup together from chat messages.

### A working setup is a head start
...
See you in the worlds you make. — The Modtale team
