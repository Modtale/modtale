...
('09-shared-list-to-pack', 'Share the setup. Keep playing.', 'From your mod list to their launcher.', 'modlist-sharing', "Found a setup worth sharing? Send a mod list.\n\nChoose configs, share the link, and install the same mods in another launcher. CurseForge entries stay labeled and download directly to the player's device.\n\nhttps://modtale.net/news/modpacks-v2", 'Day 7'),
