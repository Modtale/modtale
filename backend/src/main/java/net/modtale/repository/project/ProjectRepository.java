...
public interface ProjectRepository extends MongoRepository<Project, String>, ProjectRepositoryCustom {
    ...
    @Query(
            ...
            fields = "{ '_id': 1, 'slug': 1, 'title': 1, 'about': 1, 'description': 1, 'authorId': 1, 'author': 1, 'imageUrl': 1, 'bannerUrl': 1, 'classification': 1, 'categories': 1, 'tags': 1, 'downloadCount': 1, 'favoriteCount': 1, 'trendScore': 1, 'relevanceScore': 1, 'popularScore': 1, 'repositoryUrl': 1, 'updatedAt': 1, 'createdAt': 1, 'license': 1, 'customLicenseOpenSource': 1, 'lastTrendingNotification': 1, 'links': 1, 'types': 1, 'childProjectIds': 1, 'modIds': 1, 'allowModpacks': 1, 'allowComments': 1, 'hmWikiEnabled': 1, 'hmWikiSlug': 1, 'galleryCarouselEnabled': 1, 'status': 1, 'expiresAt': 1, 'deletedAt': 1, 'projectRoles': 1, 'teamMembers': 1, 'teamInvites': 1, 'galleryImages': 1, 'galleryImageCaptions': 1, 'comments': 1, 'versions._id': 1, 'versions.versionNumber': 1, 'versions.gameVersions': 1, 'versions.fileUrl': 1, 'versions.manifestId': 1, 'versions.modpackConfigs': 1, 'versions.downloadCount': 1, 'versions.releaseDate': 1, 'versions.changelog': 1, 'versions.dependencies': 1, 'versions.incompatibleProjectIds': 1, 'versions.channel': 1, 'versions.reviewStatus': 1 }"
    )
    ...
    @Query(
            value = "{ '_id': ?0, 'deletedAt': null }",
            fields = "{ '_id': 1, 'slug': 1, 'title': 1, 'about': 1, 'description': 1, 'authorId': 1, 'author': 1, 'imageUrl': 1, 'bannerUrl': 1, 'classification': 1, 'categories': 1, 'tags': 1, 'downloadCount': 1, 'favoriteCount': 1, 'trendScore': 1, 'relevanceScore': 1, 'popularScore': 1, 'repositoryUrl': 1, 'updatedAt': 1, 'createdAt': 1, 'license': 1, 'customLicenseOpenSource': 1, 'lastTrendingNotification': 1, 'links': 1, 'types': 1, 'childProjectIds': 1, 'modIds': 1, 'allowModpacks': 1, 'allowComments': 1, 'hmWikiEnabled': 1, 'hmWikiSlug': 1, 'galleryCarouselEnabled': 1, 'status': 1, 'expiresAt': 1, 'deletedAt': 1, 'projectRoles': 1, 'teamMembers': 1, 'teamInvites': 1, 'galleryImages': 1, 'galleryImageCaptions': 1, 'comments': 1, 'versions._id': 1, 'versions.versionNumber': 1, 'versions.gameVersions': 1, 'versions.fileUrl': 1, 'versions.manifestId': 1, 'versions.modpackConfigs': 1, 'versions.downloadCount': 1, 'versions.releaseDate': 1, 'versions.dependencies': 1, 'versions.incompatibleProjectIds': 1, 'versions.channel': 1, 'versions.reviewStatus': 1 }"
    )
    ...
    @Query(
            value = "{ '_id': ?0, 'status': { $in: ['PUBLISHED', 'UNLISTED', 'ARCHIVED'] }, 'deletedAt': null }",
            fields = "{ '_id': 1, 'slug': 1, 'title': 1, 'about': 1, 'description': 1, 'authorId': 1, 'author': 1, 'imageUrl': 1, 'bannerUrl': 1, 'classification': 1, 'tags': 1, 'downloadCount': 1, 'favoriteCount': 1, 'repositoryUrl': 1, 'updatedAt': 1, 'createdAt': 1, 'license': 1, 'customLicenseOpenSource': 1, 'links': 1, 'allowModpacks': 1, 'allowComments': 1, 'hmWikiEnabled': 1, 'hmWikiSlug': 1, 'galleryCarouselEnabled': 1, 'status': 1, 'expiresAt': 1, 'deletedAt': 1 }"
    )
    ...
    @Query(
            value = "{ '_id': ?0, 'deletedAt': null }",
            fields = "{ '_id': 1, 'slug': 1, 'title': 1, 'about': 1, 'description': 1, 'authorId': 1, 'author': 1, 'imageUrl': 1, 'bannerUrl': 1, 'classification': 1, 'tags': 1, 'downloadCount': 1, 'favoriteCount': 1, 'repositoryUrl': 1, 'updatedAt': 1, 'createdAt': 1, 'license': 1, 'customLicenseOpenSource': 1, 'links': 1, 'allowModpacks': 1, 'allowComments': 1, 'hmWikiEnabled': 1, 'hmWikiSlug': 1, 'galleryCarouselEnabled': 1, 'status': 1, 'expiresAt': 1, 'deletedAt': 1, 'projectRoles': 1, 'teamMembers': 1 }"
    )
    ...
    @Query(
            value = "{ '_id': ?0, 'status': { $in: ['PUBLISHED', 'UNLISTED', 'ARCHIVED'] }, 'deletedAt': null }",
            fields = "{ '_id': 1, 'slug': 1, 'authorId': 1, 'status': 1, 'deletedAt': 1, 'versions._id': 1, 'versions.versionNumber': 1, 'versions.gameVersions': 1, 'versions.fileUrl': 1, 'versions.manifestId': 1, 'versions.modpackConfigs': 1, 'versions.downloadCount': 1, 'versions.releaseDate': 1, 'versions.dependencies': 1, 'versions.incompatibleProjectIds': 1, 'versions.channel': 1, 'versions.reviewStatus': 1 }"
    )
