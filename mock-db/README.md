...
The fixture JSON is not checked into the repo. It is generated by the trusted [`Refresh Mock Database` workflow](https://github.com/Modtale/modtale/actions?query=workflow%3A%22Refresh%20Mock%20Database%22), validated, uploaded as a GitHub Actions artifact, and loaded into the preview template database used by PR previews.
...
Download the latest `modtale-mock-db-json` artifact from the [`Refresh Mock Database` workflow](https://github.com/Modtale/modtale/actions?query=workflow%3A%22Refresh%20Mock%20Database%22) and extract it to:
